...
resource "aws_eip" "eip_a" {
  domain = "vpc"
  tags   = merge(var.tags, { Name = "${var.name_prefix}-natgw-eip_a" })
}
resource "aws_eip" "eip_b" {
  domain = "vpc"
  tags   = merge(var.tags, { Name = "${var.name_prefix}-natgw-eip_b" })
}
resource "aws_eip" "eip_c" {
  domain = "vpc"
  tags   = merge(var.tags, { Name = "${var.name_prefix}-natgw-eip_c" })
}
